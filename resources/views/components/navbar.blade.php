<header class="sticky top-0 z-10 bg-white border-b border-gray-200" x-data="{ isOpen: false, isProductOpen: false }">
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      <a href="#" class="-m-1.5 p-1.5">
        ...
        <img class="h-12 w-auto" src="{{ asset('images/scout-spendasi.png') }}" alt="Scout Spendasi Logo">
      </a>
    </div>
  ...
  <div x-show="isOpen" class="lg:hidden" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10"></div>
      ...
      <div class="fixed inset-y-0 right-0 z-10 w-full bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 md:max-w-md lg:max-w-lg xl:max-w-xl">
