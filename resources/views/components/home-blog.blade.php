<section class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="flex justify-end mt-8">
            <a href="/all-blogs" class="inline-block px-6 py-3 text-blue-600 border border-blue-600 rounded-lg bg-white hover:bg-blue-100 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300">
                View All Blogs
            </a>
        </div>
    </div>
