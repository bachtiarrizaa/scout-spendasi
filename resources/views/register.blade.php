...
<x-layout>
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto lg:py-6">
            <div class="lg:flex">
                <div class="lg:w-1/2">
                    <img class="w-16 h-auto" src="{{ asset('images/scout-spendasi.png') }}" alt="Scout Spendasi Logo">
                ...
                <div class="mt-8 lg:w-1/2 lg:mt-0">
                    <form class="w-full lg:max-w-xl">
                        <div class="mt-4">
                            <label for="username" class="block text-sm text-gray-800 dark:text-gray-200 mb-2">Name</label>
                        ...
                        <div class="mt-4">
                            <label for="username" class="block text-sm text-gray-800 dark:text-gray-200 mb-2">Email</label>
                            <div class="relative flex items-center">
                                <span class="absolute">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-3 text-gray-300 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="mt-8 md:mt-10 sm:flex sm:items-center">
